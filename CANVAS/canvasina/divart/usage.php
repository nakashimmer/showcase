...
<title>usage DIVART | CSS3 art gallery</title>
...
<section id=howto class=wrap>
	...
	<section style="margin:10px;">
		<h1>What's DIVART ?</h1>
		<p>DIVART is "<b>CSS3 one box art</b>" on HTML5.
		<p>You can use only one div element(#divart). Please decorate it by css3!
	</section>
	...
	<section style="margin:10px;">
		...
		<style>
			...
			th,td,td i,td b{font-size:15px;font-family:serif;background-color:ivory;}
		...
		<table width=100%>
			...
			<tr><th>draw Polyline</th>
				...
				polyline(10,100,60,50,110,150,160,100);<br>
				stroke(red);
				</td>
			...
			<tr><th>draw Polygon</th>
				...
				polygon(10,100,60,50,110,60,160,100);<br>
				fill(red);
				</td>
	...
	<section style="margin:10px;">
		<h2>Publish</h2>
		<p>Sending to DIVART gallery,click publish button.</p>
	</section>
