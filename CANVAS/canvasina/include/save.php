...
<section id=wrap>
	...
	<section>
		<canvas id=canvasina width=500 height=450>
			...
			<img src=http://canvasina.com/galleryImg/{$username}_{$no}.png height=225>
		</canvas>
	...
	<footer>
		...
		<a id=share href="https://www.facebook.com/sharer/sharer.php?u=http://canvasina.com/gallery/{$username}_{$no}.html" target="_blank">Share</a>

		<!-- a id=share name="fb_share" type="button_count" share_url="http://canvasina.com/gallery/{$username}_{$no}.html"></a>
		<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script -->
		
		<div id=like style="" class="fb-like" data-href="http://canvasina.com/gallery/{$username}_{$no}.html" data-width="100" 
